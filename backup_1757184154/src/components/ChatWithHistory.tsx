...
export default function ChatWithHistory() {
  ...
  return (
    <div className="app">
      {/* Bouton flottant pour rouvrir la sidebar en mode replié */}
      {collapsed && (
      ...
      <main className="main">
        ...
        {!atBottom && (
          <button className="scroll-bottom" onClick={() => scrollToBottom(true)} title="Aller au dernier">▼ Dernier</button>
        )}
      </main>
    </div>
  );
