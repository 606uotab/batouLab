...
export default function ApiKeysPage(){
  ...
  return (
    <div className="keys-simple">
      <label className="keys-label">OpenAI</label>
      <input
        type="text"
        className="keys-input"
        placeholder="sk-..."
        value={openai}
        onChange={(e)=>{ setOpenai(e.target.value); runtimeKeys.openai = e.target.value; }}
      />

      <label className="keys-label">Anthropic</label>
      <input
        type="text"
        className="keys-input"
        placeholder="clé Anthropic…"
        value={anthropic}
        onChange={(e)=>{ setAnthropic(e.target.value); runtimeKeys.anthropic = e.target.value; }}
      />

      <label className="keys-label">Mistral</label>
      <input
        type="text"
        className="keys-input"
        placeholder="mistral-..."
        value={mistral}
        onChange={(e)=>{ setMistral(e.target.value); runtimeKeys.mistral = e.target.value; }}
      />
